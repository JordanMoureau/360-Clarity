...
function App() {
  return (
    <div className="App">
      {/* Hero Section */}
      <HeroSection
        headline="360 Clarity—Your Strategic Workplace Transformation Partner"
      ...
      <div className="info-sections-container px-6 py-12 bg-gray-50 flex justify-center">
        <div className="max-w-screen-md mx-auto">
          ...
          <InfoSection
            ...
            bullettwo="Leaders work directly with Sam, who has the experience and insigh tot make real change happen fast."
          />
